  ...
  switch (word) {
        ...
        <svg viewBox="0 0 200 160" className="w-full h-40 max-w-[240px] mx-auto">
          <defs>
            <linearGradient id="gradPagi" x1="0%" y1="100%" x2="0%" y2="0%">
              <stop offset="0%" stopColor="#0c4a3e" stopOpacity="0.2" />
              <stop offset="100%" stopColor="#14b8a6" stopOpacity="0.8" />
            </linearGradient>
          </defs>
          {/* Sun / Rising Horizon */}
          <path d="M 30 130 Q 100 70 170 130" fill="none" stroke="#2dd4bf" strokeWidth="2" strokeDasharray="4 4" />
          <circle cx="100" cy="120" r="40" fill="url(#gradPagi)" />
          {/* Rising Motion Arrow */}
          <path d="M 100 110 L 100 45" stroke="#f59e0b" strokeWidth="3" strokeDasharray="4 4" className="animate-pulse" />
          <polygon points="100,35 93,48 107,48" fill="#f59e0b" />
          {/* Hand Silhouette */}
          <g transform="translate(65, 55)">
            ...
            <circle cx="30" cy="40" r="10" fill="#2dd4bf" stroke="#ffffff" strokeWidth="2" />
          </g>
          <text x="100" y="152" textAnchor="middle" fill="#2dd4bf" fontSize="11" fontWeight="bold">
    ...
    case 'Darurat':
      return (
        <svg viewBox="0 0 200 160" className="w-full h-40 max-w-[240px] mx-auto">
          ...
          <circle cx="100" cy="70" r="55" fill="#ef4444" fillOpacity="0.15" className="animate-ping" />
          <circle cx="100" cy="70" r="40" fill="#f87171" fillOpacity="0.2" />
          {/* Crossed Arms X shape */}
          <g stroke="#ef4444" strokeWidth="12" strokeLinecap="round">
            <line x1="50" y1="110" x2="150" y2="30" />
            <line x1="150" y1="110" x2="50" y2="30" />
          </g>
          {/* Fists Overlay */}
          <circle cx="150" cy="30" r="14" fill="#dc2626" stroke="#ffffff" strokeWidth="2" />
          <circle cx="50" cy="30" r="14" fill="#dc2626" stroke="#ffffff" strokeWidth="2" />
    ...
    case 'Halo':
      return (
        <svg viewBox="0 0 200 160" className="w-full h-40 max-w-[240px] mx-auto">
          {/* Waving Arcs */}
          <path d="M 135 40 Q 155 60 135 80" fill="none" stroke="#f59e0b" strokeWidth="3" strokeLinecap="round" strokeDasharray="3 3" />
          <path d="M 145 30 Q 170 60 145 90" fill="none" stroke="#2dd4bf" strokeWidth="3" strokeLinecap="round" strokeDasharray="3 3" />
          {/* Raised Palm */}
          <g transform="translate(60, 30)">
            ...
            <path d="M 30 80 L 30 45 C 30 35 40 35 40 45 L 40 25 C 40 15 50 15 50 25 L 50 20 C 50 10 60 10 60 20 L 60 28 C 60 18 70 18 70 28 L 70 60 C 70 75 55 90 35 90 Z" 
                  fill="#14b8a6" stroke="#ffffff" strokeWidth="2" />
            {/* Thumb */}
            <path d="M 30 65 C 20 60 15 50 20 40 C 25 35 30 45 30 55 Z" fill="#2dd4bf" stroke="#ffffff" strokeWidth="2" />
          </g>
          <text x="100" y="152" textAnchor="middle" fill="#2dd4bf" fontSize="11" fontWeight="bold">
    ...
    case 'Terima Kasih':
      return (
        <svg viewBox="0 0 200 160" className="w-full h-40 max-w-[240px] mx-auto">
          ...
          <path d="M 50 30 Q 50 70 70 85" fill="none" stroke="#94a3b8" strokeWidth="3" strokeDasharray="4 4" />
          <circle cx="50" cy="30" r="10" fill="#64748b" />
          {/* Motion Arrow Forward & Down */}
          <path d="M 75 60 Q 110 60 140 90" fill="none" stroke="#2dd4bf" strokeWidth="3.5" strokeDasharray="4 4" className="animate-pulse" />
          <polygon points="145,95 133,93 140,81" fill="#2dd4bf" />
          {/* Hand Silhouette */}
          <g transform="translate(70, 45)">
            <path d="M 10 20 Q 35 10 50 20 Q 55 35 40 45 Q 20 45 10 30 Z" fill="#14b8a6" stroke="#ffffff" strokeWidth="2" />
          </g>
          <text x="100" y="152" textAnchor="middle" fill="#2dd4bf" fontSize="11" fontWeight="bold">
      ...
      return (
        <svg viewBox="0 0 200 160" className="w-full h-40 max-w-[240px] mx-auto">
          ...
          <g transform="translate(65, 25)">
            {/* Left Palm */}
            <path d="M 35 85 L 35 25 C 35 15 25 20 25 30 L 25 75 Z" fill="#0d9488" stroke="#ffffff" strokeWidth="2" />
            {/* Right Palm */}
            <path d="M 35 85 L 35 25 C 35 15 45 20 45 30 L 45 75 Z" fill="#14b8a6" stroke="#ffffff" strokeWidth="2" />
            {/* Wrist joint */}
            <rect x="23" y="75" width="24" height="15" rx="4" fill="#0c4a3e" stroke="#ffffff" strokeWidth="1" />
          </g>
          {/* Downward Motion Arrows */}
          <path d="M 100 100 L 100 125" stroke="#f59e0b" strokeWidth="3" strokeDasharray="3 3" />
          <polygon points="100,132 94,122 106,122" fill="#f59e0b" />
          <text x="100" y="152" textAnchor="middle" fill="#2dd4bf" fontSize="11" fontWeight="bold">
    ...
    case 'Maaf':
      return (
        <svg viewBox="0 0 200 160" className="w-full h-40 max-w-[240px] mx-auto">
          ...
          <path d="M 100 35 A 35 35 0 1 1 65 70" fill="none" stroke="#2dd4bf" strokeWidth="3" strokeDasharray="4 4" />
          <polygon points="65,60 60,74 74,72" fill="#2dd4bf" />
          {/* Fist Icon */}
          <g transform="translate(80, 50)">
            <rect x="0" y="0" width="40" height="35" rx="10" fill="#14b8a6" stroke="#ffffff" strokeWidth="2" />
    ...
    case 'Saya':
      return (
        <svg viewBox="0 0 200 160" className="w-full h-40 max-w-[240px] mx-auto">
          {/* Torso/Chest Outline */}
          <path d="M 60 120 C 60 80 140 80 140 120" fill="none" stroke="#64748b" strokeWidth="3" strokeDasharray="4 4" />
          <circle cx="100" cy="100" r="6" fill="#2dd4bf" />
          {/* Pointing Index Finger Hand */}
          <g transform="translate(85, 30)">
            <rect x="10" y="0" width="10" height="45" rx="5" fill="#2dd4bf" stroke="#ffffff" strokeWidth="2" />
            <rect x="0" y="35" width="30" height="25" rx="8" fill="#14b8a6" stroke="#ffffff" strokeWidth="2" />
          </g>
          {/* Downward Arrow */}
          <path d="M 100 65 L 100 90" stroke="#f59e0b" strokeWidth="3" strokeDasharray="3 3" />
          <polygon points="100,96 94,86 106,86" fill="#f59e0b" />
          <text x="100" y="152" textAnchor="middle" fill="#2dd4bf" fontSize="11" fontWeight="bold">
    ...
    case 'Kamu':
      return (
        <svg viewBox="0 0 200 160" className="w-full h-40 max-w-[240px] mx-auto">
          ...
          <path d="M 100 80 L 100 35" stroke="#2dd4bf" strokeWidth="3.5" strokeDasharray="4 4" className="animate-pulse" />
          <polygon points="100,25 93,38 107,38" fill="#2dd4bf" />
          {/* Pointing Hand */}
          <g transform="translate(85, 65)">
            <rect x="10" y="0" width="10" height="40" rx="5" fill="#2dd4bf" stroke="#ffffff" strokeWidth="2" />
            <rect x="0" y="25" width="30" height="25" rx="8" fill="#14b8a6" stroke="#ffffff" strokeWidth="2" />
          </g>
          <text x="100" y="152" textAnchor="middle" fill="#2dd4bf" fontSize="11" fontWeight="bold">
    ...
    default:
      return (
        <svg viewBox="0 0 200 160" className="w-full h-40 max-w-[240px] mx-auto">
          <circle cx="100" cy="70" r="35" fill="#0d9488" fillOpacity="0.2" stroke="#2dd4bf" strokeWidth="2" />
          <g transform="translate(85, 45)">
            <path d="M 15 50 L 15 20 C 15 10 25 10 25 20 L 25 45 Z" fill="#14b8a6" stroke="#ffffff" strokeWidth="2" />
          </g>
          <text x="100" y="152" textAnchor="middle" fill="#2dd4bf" fontSize="11" fontWeight="bold">
...
export default function FeatureDictionaryPage({ onNavigate, showToast }) {
  ...
  const [selectedDialect, setSelectedDialect] = useState('Semua');
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="liquid-glass rounded-3xl p-6 border border-white/90 shadow-lg space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-2">
          <span className="text-xs font-bold text-[#0c4a3e]/70 uppercase tracking-wider">
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all duration-200 ${
                  selectedDialect === dialect
                    ? 'bg-[#0c4a3e] text-[#d9f99d] shadow-xs'
          ...
          <button
            ...
            className={`px-5 py-2 rounded-full text-xs font-bold whitespace-nowrap shrink-0 transition-all duration-200 ${
              selectedCategory === cat
                ? 'bg-[#0c4a3e] text-white shadow-md shadow-[#0c4a3e]/20'
                : 'glass-pill text-slate-700 hover:border-[#0c4a3e]/30'
            }`}
          >
            {cat}
          </button>
      ...
      {/* Expandable Dictionary Cards Grid */}
            ...
            return (
              <div 
                ...
                className={`rounded-[32px] border transition-all duration-300 overflow-hidden ${
                  isExpanded 
                    ? 'liquid-glass-teal border-[#14b8a6] ring-2 ring-[#14b8a6]/20 shadow-xl' 
                    : 'liquid-glass border-white/90 hover:border-[#0c4a3e]/30 shadow-md hover:-translate-y-0.5'
                }`}
              >
                {/* Main Card Header */}
                <div className="p-6 md:p-7 space-y-4">
                  <div className="flex items-center justify-between">
                    <span className={`px-2.5 py-1 rounded-lg text-[10px] font-bold ${
                      item.dialect === 'BISINDO' 
                        ? 'bg-[#0c4a3e]/10 text-[#0c4a3e] border border-[#0c4a3e]/20' 
                  ...
                  <div>
                    <h3 className="text-2xl font-serif font-bold text-[#0c4a3e]">
                      {item.word}
                    </h3>
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-4 rounded-2xl text-xs font-bold flex items-center justify-center gap-2 transition-all duration-200 active:scale-98 ${
                      isExpanded
                        ...
                        : 'bg-emerald-50/80 hover:bg-emerald-100/80 text-[#0c4a3e] border border-emerald-200/60'
                    }`}
                  >
                ...
                {/* Expanded Inline Hand Sign Visual Section */}
                {isExpanded && (
                  <div className="px-6 pb-7 pt-2 border-t border-[#14b8a6]/20 space-y-5 animate-in fade-in zoom-in-95 duration-200 bg-white/50 backdrop-blur-md">
                    
                    {/* Visualizer Frame with Hand Illustration */}
                    <div className="relative bg-gradient-to-br from-[#062c25] to-[#0c4a3e] rounded-2xl p-4 overflow-hidden border border-emerald-900 shadow-inner flex flex-col items-center justify-center">
                      ...
                      {/* Top Label */}
                      <div className="w-full flex items-center justify-between text-[10px] text-[#2dd4bf] font-bold mb-2">
                    ...
                    {/* Step Instructions */}
                    <div className="bg-white/90 backdrop-blur-md rounded-2xl p-4 border border-slate-200/60 shadow-xs space-y-2">
                      <div className="flex items-center gap-1.5 text-xs font-bold text-[#0c4a3e] uppercase tracking-wider">
